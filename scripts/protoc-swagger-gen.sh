...
declare -a deps=("github.com/cosmos/cosmos-sdk"
                ...
                "github.com/Team-Kujira/ibc-go/v8@v8.3.2-factory2")
...
for dir in $proto_dirs; do
  ...
  if [[ ! -z "$query_file" ]]; then
    buf generate --template proto/buf.gen.swagger.yml $query_file
  fi
done
...
rm -rf tmp-swagger-gen/cosmos/feegrant
...
swagger-merger --input ./tmp-swagger-gen/tmp_swagger.yaml -o ./docs/static/openapi.yml
