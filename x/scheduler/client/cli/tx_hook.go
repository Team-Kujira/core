...
func CreateHookProposalCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) (err error) {
			...
			proposalTitle, err := cmd.Flags().GetString(cli.FlagTitle) //nolint:staticcheck // ignore deprecated flag
			if err != nil {
				return fmt.Errorf("proposal title: %s", err)
			}

			proposalDescr, err := cmd.Flags().GetString(cli.FlagDescription) //nolint:staticcheck // ignore deprecated flag
			if err != nil {
	...
	cmd.Flags().String(cli.FlagTitle, "", "Title of proposal")             //nolint:staticcheck // ignore deprecated flag
	cmd.Flags().String(cli.FlagDescription, "", "Description of proposal") //nolint:staticcheck // ignore deprecated flag
	cmd.Flags().String(cli.FlagDeposit, "", "Deposit of proposal")
	cmd.Flags().String(cli.FlagProposal, "", "Proposal file path (if this path is given, other proposal flags are ignored)") //nolint:staticcheck // ignore deprecated flag
	return cmd
}
