...
func TestQueryExchangeRates(t *testing.T) {
	...
	plugin := wasmbinding.NewQueryPlugin(app.BankKeeper, app.OracleKeeper, *app.DenomKeeper, *app.IBCKeeper, app.CwICAKeeper, app.AllianceKeeper, app.GetKey(ibcexported.StoreKey))
