...
// source: kujira/scheduler/legacy_proposal.proto
...
import (
	...
	_ "github.com/Team-Kujira/core/x/scheduler/types"
...
func (*CreateHookProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_388a0119cb7ba3a9, []int{0}
}
...
func (*UpdateHookProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_388a0119cb7ba3a9, []int{1}
}
...
func (*DeleteHookProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_388a0119cb7ba3a9, []int{2}
}
...
func init() {
	proto.RegisterFile("kujira/scheduler/legacy_proposal.proto", fileDescriptor_388a0119cb7ba3a9)
}

var fileDescriptor_388a0119cb7ba3a9 = []byte{
	// 461 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *CreateHookProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
		...
		for iNdEx := len(m.Funds) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintLegacyProposal(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x3a
		}
	...
	if m.Frequency != 0 {
		i = encodeVarintLegacyProposal(dAtA, i, uint64(m.Frequency))
		i--
		dAtA[i] = 0x30
	}
	if len(m.Msg) > 0 {
		i -= len(m.Msg)
		copy(dAtA[i:], m.Msg)
		i = encodeVarintLegacyProposal(dAtA, i, uint64(len(m.Msg)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Contract) > 0 {
		...
		i = encodeVarintLegacyProposal(dAtA, i, uint64(len(m.Contract)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Executor) > 0 {
		...
		i = encodeVarintLegacyProposal(dAtA, i, uint64(len(m.Executor)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Description) > 0 {
		...
		i = encodeVarintLegacyProposal(dAtA, i, uint64(len(m.Description)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Title) > 0 {
		i -= len(m.Title)
		copy(dAtA[i:], m.Title)
		i = encodeVarintLegacyProposal(dAtA, i, uint64(len(m.Title)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *UpdateHookProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Id != 0 {
		i = encodeVarintLegacyProposal(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Description) > 0 {
...
func encodeVarintLegacyProposal(dAtA []byte, offset int, v uint64) int {
	offset -= sovLegacyProposal(v)
	base := offset
	for v >= 1<<7 {
...
func (m *CreateHookProposal) Size() (n int) {
	...
	l = len(m.Title)
	if l > 0 {
		n += 1 + l + sovLegacyProposal(uint64(l))
	}
	l = len(m.Description)
	if l > 0 {
		n += 1 + l + sovLegacyProposal(uint64(l))
	...
	if m.Frequency != 0 {
		n += 1 + sovLegacyProposal(uint64(m.Frequency))
	}
	if len(m.Funds) > 0 {
...
func (m *UpdateHookProposal) Size() (n int) {
	...
	if m.Id != 0 {
		n += 1 + sovLegacyProposal(uint64(m.Id))
	}
	l = len(m.Executor)
	if l > 0 {
		n += 1 + l + sovLegacyProposal(uint64(l))
...
func sovLegacyProposal(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozLegacyProposal(x uint64) (n int) {
	return sovLegacyProposal(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *CreateHookProposal) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowLegacyProposal
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthLegacyProposal
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipLegacyProposal(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipLegacyProposal(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowLegacyProposal
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthLegacyProposal
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupLegacyProposal
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthLegacyProposal        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowLegacyProposal          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupLegacyProposal = fmt.Errorf("proto: unexpected end of group")
)
